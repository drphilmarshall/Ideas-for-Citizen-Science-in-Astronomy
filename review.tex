...
% Arxvi seems to want just one tex file...
% \input{macros.tex}
...
\caption{Examples of high-fidelity images obtained by amateur planetary observers.  Credit:  Damian Peach (UK) for Venus, Mars and Neptune images; Christopher Go (Philippines) for Jupiter; Darryl Pfitzner Milika and Patricia Nicholas (Australia) for Saturn; and Anthony Wesley (Australia) for Uranus \citep[see][for a thorough review of amateur planetary astronomy]{14mousis_proam}.}
\label{fig:planets}
\end{figure}
%%%%%%%%%%%%%%%%%%%
...
%%%%%LNF:  I removed this section, as I didn't feel it was appropriate in the citizen-led enquiry section.
...
comments, and clarifications: Trevor Barry, Anthony Wesley, Damian Peach, Christopher Go, Ricardo Hueso, John Rogers, Grischa Hahn\textit{LNF:  did you speak with Grischa?}, ... 
