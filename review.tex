...
%
% 14000 words, 70 references, 2 large figures: 30 pages
...
\citet{Lang++2011} used more than 2000 images scraped from the photo sharing
...
the Flickr site. \citeauthor{Lang++2011} were able to astrometrically calibrate
many of the images using their automatic image registration software,
\texttt{astrometry.net}, which detects the stars in each image and matches them
...
substantial contribution -- is illustrated in \Fref{} which shows results from
...
To date, over XXXXX people have participated in the Galaxy Zoo project, but such
...
rewards consistency, first described in \citet{Land++}, was deemed sufficient.
%
...
\citep[see][]{Bamford++}. The net result is that the Galaxy Zoo classifications
are an excellent match for results from expert classification, and have produced
science ranging from studies of red spirals \citep{Masters++} to investigations
of spiral spin \citep{Slosar++}.
A full review of Galaxy Zoo science is beyond the scope of this review; a recent
summary is given in the Galaxy Zoo 2 data release paper by \citet{Willett++}.
...
% \todo{Chris}{\#38 Provide clickworkers reference.}
...
\label{SNZoo} \citet{threeVs} describe three defining aspects of ``Big Data''
that make its analysis challenging: volume, velocity and variety. Time-domain
astronomy projects, that require the immediate inspection of challenging volumes
of live, high velocity, complex data, can benefit from citizen science, as shown
by two recent projects, Supernova Zoo and Planet Hunters.  
While transients such as supernovae or asteroids can often be found through the
use of automatic routines, visual inspection is still used by many professional
science teams as part of their process of selecting candidates for follow-up. 
...
planet \citep{Schwamb++PH1b} and   a circumbinary, is the first planet known in
a four-star system. Others, including the more than forty candidates identified
in the habitable zone of their parent star by \citep{Ji++PH}, might have been
...
(Schwamb et al.) and has inspired improvements in subsequent analysis (Bathalia
et al.). More recently, advanced users have participated in the identification
of unusual stellar properties - see XXXXXXXX. 

% \todo{Chris}{provide bibtex references in Planet Hunters section \#83}
...
% \todo{Chris}{\#90 Include Eyewire citations, URL}
...
not identified in the \citeauthor{SimpsonEtal2012} catalog. These bubbles were
...
as accurate as those derived by experts \citep{KuengEtal2014}. A pilot
collaborative modeling analysis was carried out and written up by a small group
of Space Warps volunteers\footnote{See
...
planet atmosphere \citep{Fischer++2011},  and the vertices of Saturn's bizarre
...
``Hanny's Voorwerp'' \citep{Lintott++Voorwerp}, a galaxy-scale light echo which
reveals a recent ($\sim 100,000$ years ago)  shutdown of AGN activity in IC
2497, a neighboring spiral galaxy. The discovery of the Voorwerp was first
...
SDSS imaging, green systems are dwarf galaxies with specific star formation rates
...
systems, but organized a systematic search and further review of them. This
effort included the use of tools designed by SDSS for professional astronomers
to acquire and study spectroscopic data. 

% \todo{Chris}{\#94 References for green peas?}
...
% \todo{Chris}{\#55 Write up Galaxy Zoo Quench! Including references...}
...
modeling analysis, using their own tools. A small group of volunteers downloaded
full Kepler lightcurve datasets for the best community-selected candidates, and
fitted transit lightcurves to them using commercially available software. 

% \todo{Chris}{\#51 Add text to PH talk case study:  What did the super-users
% actually do in the way of advanced lightcurve modeling? Did it make it to the
% paper? We need references. This seems to me like something of a triumph, we must
...
\todo{Phil}{revisit this section post Foldit. \#86}

As seen in \Sref{sec:class:non-astro} and \Sref{sec:model} 
...
interpreting their observations, no? \#84}
...
form communities and work together on the internet.  A number of productive
``Pro-Am collaborations'' have formed, to observe a variety of bright
...
research. Citizens have been challenged to take part in data analysis tasks of
increasing sophistication and difficulty, and experiments in
professionally-guided ``bottom up'' citizen research have begun.
...
and operate in  niches not occupied either by professional observers or
automated classification software. The citizen astronomers are passionate about
the subject, and  motivated by being of service to science. We must recognize
...
drives us to seek out those  tasks that cannot be done by other means. We have
also seen something of the ability of citizen science to improve the performance
of  machine learning as well as professional observing projects: it makes sense
to think in terms of ``human-machine partnerships.''

The observational and classification communities are similar in their diversity
regarding both motivation and ability to contribute;  this diversity means that
good citizen science projects are ones that provide both a low barrier to entry,
but that also providing (or supporting the development of) tools that enable
their emergent experts to maximize their contributions to science.  Indeed, the
most dedicated volunteers have proved capable of developing and using fairly
advanced astronomical techniques, suggesting that we are likely to continue to
see the numbers of citizens co-authoring papers in high impact research journals
increase.
...
made progress in astronomy -- and also  revealed something about the how citizen
science can work. Human potential is vast: citizen astronomy seems an experiment
