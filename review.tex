...
Incorporating this sort of analysis in projects using a live stream of data, rather than an archive, will
be a major challenge, requiring real time analysis of classifications. In particular, strategies which require each classification to update our knowledge of every subject being classified and every user will likely be expensive, and `progressive' strategies that approximate the best case need to be developed. 
\todo{Phil}{\#72 Does this make more sense now?}
