...
\todo{Chris}{Finish off Barentsen twitter meteor project piece.}
...
2. 
\todo{Chris}{Insert box diagram illustrating Zooniverse tactics / GZ2 results.} 
...
\todo{Chris}{Review Richards and Bloom's contribution. Add SN zoo, PTF refs.}
...
\todo{Chris}{Bibtex the refs for time domain astronomy!}
...
\todo{Chris}{this statement about real time analysis in live projects needs a sentence explaining what the challenge actually is!}
...
\todo{Phil}{Provide URLs for spaghettilens and modeling thread on Talk.}
...
\todo{Chris}{Check through the merger zoo case study, ensure refs are up to date.} 
Here, simple
...
\todo{Phil}{Update Kaggle challenge with Galaxy Zoo. Ask Kyle for spiel.}
...
\todo{Chris}{Add more citations for voorwerp science?}
...
\todo{Chris}{Follow up Galaxy Zoo Quench...}
...
\todo{Chris}{Add text to PH talk case study: What did the super-users actually do in the way of advanced lightcurve modeling? Did it make it to the paper? References. This seems to me like something of a triumph, we must give it a good airing!}
...
\todo{Chris}{Read the motivation section to see if it works well for discussing motivation and gamification the way you want to.}
...
\todo{Phil}{Update the motivation section with any latest results. Ask the Zooniverse team.}

\todo{Phil}{Update the demographics section with any latest results. Ask the Zooniverse team.}
...
\todo{Phil,Chris}{Look at the future section together, plan it based on review so far. What are the key themes? Focus on them?}
...
\todo{Phil}{Write up possibilities of future citizen astronomy}.
...
\todo{Phil}{Write up challenges of future citizen astronomy}.
...
\todo{Chris}{Compose 2-3 paragraphs, or better, an itemized list, of the  characteristics of successful citizen science, drawing from the notes already in place.}
