...
GREAT challenges, the authors find a factor of several improvement in shear
...
datasets (and consequent stability of the leaderboard), 
the choice of leaderboard metric and so on. While providing valuable feedback
for the challenge organisers at Kaggle, these issues are also of generic
importance for scientists looking to crowd-source algorithm development.
